    ...
    <header className="sticky top-0 z-50 w-full bg-primary/95 backdrop-blur-md">
      <div className="container flex items-center justify-between h-16 md:h-20">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <a href="#cities" className="text-sm text-cream/80 hover:text-cream transition-colors">Города</a>
        ...
        <div className="flex items-center gap-3">
          <button aria-label="Помощь" className="hidden sm:grid place-items-center w-10 h-10 rounded-full border border-cream/20 text-cream/80 hover:text-cream hover:border-cream/40 transition-colors">
            <HelpCircle className="w-5 h-5" />
          </button>
          <button aria-label="Уведомления" className="relative grid place-items-center w-10 h-10 rounded-full border border-cream/20 text-cream/80 hover:text-cream hover:border-cream/40 transition-colors">
